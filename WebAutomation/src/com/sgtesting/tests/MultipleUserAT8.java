...
class Usermultiple
{
	...
	static void Loginu1()
	{
		try
		{
			oBrowser.findElement(By.id("username")).sendKeys("user1111");
	...
	static void modifiu1()
	{
		try
		{
			oBrowser.findElement(By.xpath("//*[@id=\'topnav\']/tbody/tr[1]/td[5]/a/div[2]")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath(" //span[text()='awanti, user1111']")).click();
			Thread.sleep(2000);
	...
	static void modiu3()
	{
		try
		{
			...
			oBrowser.findElement(By.xpath(" //span[text()='awanti, user3']")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.name("password")).sendKeys("1111");
			Thread.sleep(2000);
			oBrowser.findElement(By.id("userDataLightBox_passwordCopyField")).sendKeys("1111");
