	...
	static void modi()
	{
		try
		{
			 ...
			 oBrowser.findElement(By.name("email")).clear();
				Thread.sleep(2000);
				oBrowser.findElement(By.name("email")).sendKeys("anushkadhanraj@gmail.com");
