...
class ModCustomer
{
	...
	static void Modi()
	{
		try
		{
			...
			oBrowser.findElement(objmap.getLocator("descriptionbox")).sendKeys("1");
			Thread.sleep(2000);
...
public class ModiCustomer {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		ModCustomer.launchBrowser();
		ModCustomer.navigate();
		ModCustomer.login();
		ModCustomer.minimizeFlyOutWindow();
		ModCustomer.CreateCustomer();
		ModCustomer.Modi();
		ModCustomer.DeleteCustomer();
		ModCustomer.logout();
		ModCustomer.closeApplication();
