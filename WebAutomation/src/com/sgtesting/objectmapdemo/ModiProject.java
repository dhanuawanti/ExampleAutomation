...
class ModiPro
{
	...
	static void Modi()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(objmap.getLocator("descriptionofproject")).sendKeys(" weddings");
			Thread.sleep(2000);
			oBrowser.findElement(objmap.getLocator("closebuttonforProject")).click();
			Thread.sleep(3000);
...
public class ModiProject {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		ModiPro.launchBrowser();
		ModiPro.navigate();
		ModiPro.login();
		ModiPro.minimizeFlyOutWindow();
		ModiPro.CreateCustomer();
		ModiPro.CreateProject();
		ModiPro.Modi();
		ModiPro.DeleteProject();
		ModiPro.DeleteCustomer();
		ModiPro.logout();
		ModiPro.closeApplication();
